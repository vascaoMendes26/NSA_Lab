...
e a simulação foi realzada no software Cadence Virtuoso. Na Figura \ref{fig:Schematic} está apresentado o esquemático do circuito. 
...
\begin{table}[h!]
    ...
    \begin{tabular}{cc}
        ...
        \hline
        Gain Bandwidth Product ($C_L = 8 \, \text{pF}$) & $GBW \approx 50 \, \text{MHz}$ \\ 
        \hline
