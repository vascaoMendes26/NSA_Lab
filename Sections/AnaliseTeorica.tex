...
\begin{figure}[h!]
    ...
    \caption{Simplificação realizada para efeitos de simplificação na Análise Teórica}
...
dos nós internos do circuito, mais concretamente, os nós que correspondem às fontes, como é possível ver na Figura \ref{fig:SimplificadoMaximo} está legendado onde estão localizados estes dois polos,
...
\textcolor{red}{Imagens aqui também?? Desenho Amanhã que tou com perguiça já apanhei rage bait com a de cima}
...
tendo em conta que foi ralizada uma amproximaçaõ e não foram contabilizados os excessos de ruído dos transistores em configuração de Cascode. 
